...
namespace Schematron.Insight.Validation.Report.Strategies
{
    ...
    /// </summary>
    public class ReportHtmlStrategy : IReportStrategy
    {
        ...
        #endregion
        #region Constructor
        public ReportHtmlStrategy()
        {
            Name = "Html";
            Description = "Serialize can available, but Deserialize cannot.";
        }
        #endregion
        ...
        public string Serialize(Reporter reporter)
        {
            ...
            try
            {
                ...
                html.Title = "検証結果";
                html.ApplicationInfo = $"Report By: {reporter.ReportBy}";
                html.ModifiedInfo = $"Written To: {reporter.WrittenTo}";
                html.TotalSyntaxError = $"Syntax Error: {reporter.TotalSyntaxError,4}";
                html.TotalAssert = $"Total Assert: {reporter.TotalAssert,4}";
                html.TotalReport = $"Total Report: {reporter.TotalReport,4}";

                IEnumerable<IGrouping<string, Result>> query = reporter.Results.GroupBy(item => item.XmlFile.FullName);
        ...
        #endregion
        #region HtmlReporter Class
        private class HtmlReporter
        {
